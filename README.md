...
1. In the **...** menu at the top right corner click **Repositories**, add
   `https://github.com/lmagyar/homeassistant-addon-portainer-beta` as
   repository.
1. Find the "[BETA] Portainer" add-on and click it. If it doesn't show up, wait
...
[Info]: https://github.com/lmagyar/homeassistant-addon-portainer-beta/blob/main/portainer/README.md
[Documentation]: https://github.com/lmagyar/homeassistant-addon-portainer-beta/blob/main/portainer/DOCS.md
